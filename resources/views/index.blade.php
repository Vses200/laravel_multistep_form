            ...
            <div class="card px-5 py-3 mt-5 shadow">
               <h1 class="text-danger text-center mt-3 mb-4">Multi-step Form in Laravel 9</h1>
                        ...
                        <div class="nav nav-fill my-3">
                          <label class="nav-link shadow-sm step0    border ml-2  active_nav">Step One</label>
...
$(function(){
    ...
    function curIndex(){
        ...
        const index = $sections.index($sections.filter('.current'));
        console.log(index+1);
        return index;
    }

    $('.form-navigation .previous').click(function(){
        $('.step'+curIndex()).toggleClass('active_nav');
    ...
    $('.form-navigation .next').click(function(){
        $('.employee-form').parsley().whenValidate({
            ...
            $('.step'+(curIndex()+1)).toggleClass('active_nav');
            navigateTo(curIndex()+1);
